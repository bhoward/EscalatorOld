...
/**
  ...
  */
object Square {
  def apply(anX: Double, aY: Double, aL: Double) = new Square(anX, aY, aL)
  def apply(anX: Double, aY: Double, aL: Double, c: Color) = new Square(anX, aY, aL, c)
  def apply(anX: Double, aY: Double, aL: Double, c1: Color, c2: Color) = new Square(anX, aY, aL, c1, c2)
}

/**
  Candidate square primitive for the graphics component in SCALES.  The default constructor will
  make a black square
  
  @author Cory Boatright, boatrightcd@hiram.edu
  @version June 15, 2007
  @param anX The x-coordinate of the top-left corner of the square
  @param aY The y-coordinate of the top-left corner of the square
  @param aL The length of the square's side
  */
class Square(anX: Double, aY: Double, aL: Double) extends Rectangle2D.Double(anX, aY, aL, aL) with ShapeExt {
  ...
  /**
    Secondary constructor that allows a different initial color for the square
    
    @param anX The x-coordinate of the top-left corner of the square
    @param aY The y-coordinate of the top-left corner of the square
    @param aL The length of the square's side
    @param c The initial color for the square
    */
  def this(anX: Double, aY: Double, aL: Double, c: Color) = {
    this(anX, aY, aL)
    intColor = c
    extColor = c
  }
  ...
  /**
    Secondary constructor that allows a different initial fill and outline colors for the square
    
    @param anX The x-coordinate of the top-left corner of the square
    @param aY The y-coordinate of the top-left corner of the square
    @param aL The length of the square's side
    @param c1 The initial fill color for the square
    @param c2 The initial outline color for the square
    */
  def this(anX: Double, aY: Double, aL: Double, c1: Color, c2: Color) = {
    this(anX, aY, aL)
    intColor = c1
    extColor = c2
  }
  ...
  /**
    Allows for expanding or reducing the square by a given ratio
  ...
  /**
    Allows the changing the square to a different color, fill and outline will be the same
  ...
  /**
    Allows the changing of the square to use a different outline and fill color
  ...
  /**
    Allows for the changing of the square's outline color only
  ...
  /**
    Allows for the changing of the square's fill color only
