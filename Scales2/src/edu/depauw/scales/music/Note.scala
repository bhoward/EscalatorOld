...
case object C extends Note(0, 1)
case object D extends Note(2, 1)
case object E extends Note(4, 1)
case object F extends Note(5, 1)
case object G extends Note(7, 1)
case object A extends Note(9, 1)
case object B extends Note(11, 1)
